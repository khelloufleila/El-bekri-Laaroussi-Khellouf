...
from keras.layers import Dense, Activation, Flatten, Input, Dropout, MaxPooling1D, Conv1D
...
from keras.layers import Dense, Dropout, Activation, Embedding, Bidirectional,Input,Lambda
from keras.layers import LSTM, Lambda, concatenate, Masking, SimpleRNN, GRU
...
##Data cleaning
df['cleaned_tweet'] = df['text'].apply(utils.clean_tweet)
...
def creat_model():
    ...
    forward_sent = GRU(128, return_sequences=False, dropout=0.2, consume_less='gpu')(embedded)
